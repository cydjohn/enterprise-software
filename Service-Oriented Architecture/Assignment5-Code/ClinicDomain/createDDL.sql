...
CREATE TABLE TREATMENT (ID BIGINT NOT NULL, TTYPE VARCHAR(31), DIAGNOSIS VARCHAR(255), patient_fx BIGINT, provider_fx BIGINT, PRIMARY KEY (ID))
...
ALTER TABLE TREATMENT ADD CONSTRAINT FK_TREATMENT_provider_fx FOREIGN KEY (provider_fx) REFERENCES PROVIDER (ID)
