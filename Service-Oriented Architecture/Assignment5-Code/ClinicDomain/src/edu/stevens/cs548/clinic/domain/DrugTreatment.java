...
public class DrugTreatment extends Treatment implements Serializable {
	...
	public void visit(ITreatmentVisitor visitor) {
		visitor.visitDrugTreatment(this.getId(), this.getDiagnosis(), this.getDrug(), this.getDosage(),this.getProvider());
	}

	public <T> T export(ITreatmentExporter<T> visitor) throws TreatmentExn {
